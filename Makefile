...
all: ${MULTICALL_PREFIXED} ${CMDS_PREFIXED} ${EXECUTOR_SCRIPTS_NATIVE}

${LIBIFUPDOWN_EXECUTOR_LIB_PREFIXED}: ${LIBIFUPDOWN_EXECUTOR_OBJ_PREFIXED}
	${AR} -rcs $@ ${LIBIFUPDOWN_EXECUTOR_OBJ_PREFIXED}

TARGET_LIBS = ${LIBIFUPDOWN_LIB} ${LIBIFUPDOWN_EXECUTOR_LIB}
TARGET_LIBS_PREFIXED = $(addprefix ${BUILDDIR_},${TARGET_LIBS})
LIBS += -static ${TARGET_LIBS_PREFIXED} ${LIBBSD_LIBS} ${LIBMNL_LIBS}
