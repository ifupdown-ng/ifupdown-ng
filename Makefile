...
all: ${MULTICALL} ${CMDS} ${EXECUTOR_SCRIPTS_NATIVE}
...
${LIBIFUPDOWN_EXECUTOR_LIB}: ${LIBIFUPDOWN_EXECUTOR_OBJ}
	${AR} -rcs $@ ${LIBIFUPDOWN_EXECUTOR_OBJ}

clean:
	rm -f ${LIBIFUPDOWN_EXECUTOR_OBJ} ${LIBIFUPDOWN_OBJ} ${MULTICALL_OBJ}
